...
export default function About() {
  return (
    <div className="flex justify-center items-center pl-32 pr-32 pt-10 pb-10 gap-16 bg-slate-50">
        <img src={myImage} alt="" className='h-80 rounded'/>
        <div className="flex flex-col justify-start">
            <h2 className='text-3xl font-bold'>Hello, I'm Piyush 👋</h2>
            <h3 className='text-xl text-cyan-500'>CS Honors + Math @ Texas A&M</h3>
