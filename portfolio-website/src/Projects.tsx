...
export default function Projects() {
    return (
        <div className="pl-32 pr-32 pt-10 pb-10 bg-slate-100">
            <h1 className='text-3xl font-bold'>Projects</h1>
            <div className="flex justify-between items-center gap-20 mt-4">
                <div className='border border-white rounded-md p-4 w-96'>
                    <img src={project1} alt="" className='w-80 rounded'/>
                    <h1 className='text-xl font-bold text-cyan-500 mt-4'>NFL Discord Bot</h1>
                ...
                <div className='border border-white rounded-md p-4 w-96'>
                    ...
                    <h1 className='text-xl font-bold text-cyan-500 mt-4'>AggieStops</h1>
                ...
                <div className='border border-white rounded-md p-4 w-96'>
                    ...
                    <h1 className='text-xl font-bold text-cyan-500 mt-4'>Astrid: Safety App</h1>
