        ...
        <div className="pl-32 pr-32 pt-10 pb-10 bg-purple-400">
            ...
            <div className="flex justify-between items-center gap-20">
                <div className='border rounded-md p-4'>
                    <img src={project1} alt="" className='h-48 rounded'/>
                    <h1>NFL Discord Bot</h1>
                ...
                <div className='border rounded-md p-4'>
                    <img src={project2} alt="" className='h-48 rounded'/>
                    <h1>AggieStops</h1>
                ...
                <div className='border rounded-md p-4'>
                    <img src={project3} alt="" className='h-48 rounded'/>
                    <h1>Astrid: Safety App</h1>
